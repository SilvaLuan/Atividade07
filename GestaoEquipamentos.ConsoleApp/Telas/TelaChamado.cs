...
namespace GestaoEquipamentos.ConsoleApp.Telas
{
    public class TelaChamado : TelaBase
    {
        ...
        public override void VisualizarRegistros()
        {
            ...
            {
                Console.WriteLine("{0,-10} | {1,-20} | {2,-35} | {3,-25} | {4,-30}",
        ...
        private static void MontarCabecalhoTabela()
        {
            ...
            Console.WriteLine("{0,-10} | {1,-20} | {2,-35} | {3,-25} | {4,-30}", "Id", "Equipamento", "Solicitante", "Título", "Dias em Aberto");
        ...
        private bool GravarChamado(int idChamadoSelecionado)
        {
            ...
            Console.Write("Digite o Id de solicitante: ");
